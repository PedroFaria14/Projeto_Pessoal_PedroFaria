...
const Courses = ({ menuOpen }) => {
  return (
    ...
    <main className={styles.cards}>
        ...
        <section className={styles.card1}>
        <h5><b>REST API's RESTFul do O à AWS c. Spring Boot 3 Java e Docker</b></h5>
        <p>
        No curso "REST API's RESTFul do O à AWS com Spring Boot 3, Java e Docker", aprendi a desenvolver APIs RESTful de ponta a ponta, desde a criação com Spring Boot até a implantação. 
        </p>
    </section>
    <section className={styles.card1}>
...
No curso "Desvendando a Blockchain" no SENAI, adquiri conhecimentos fundamentais sobre a tecnologia blockchain e suas aplicações.
</p>
</section>
<section className={styles.card1}>
