...
<main className={styles.cards}>
  ...
  <section className={styles.card1}>
    <h3><span>Details_Movies</span></h3>
    <p>
    Projeto pessoal de um site dedicado ao universo cinematográfico, oferecendo aos usuários a possibilidade de pesquisar e descobrir os melhores filmes.</p>
   <br/> <br/><a href="https://github.com/PedroFaria14/Details_Movies"><button>Ver Mais</button></a>
  </section>
</main>
</div>
